function createAdminHeader() {
    return '<!-- adminHeader -->' +
        '<header class="bg-white shadow-md py-4 px-8 flex justify-between items-center absolute top-0 left-36">\n' +
        '            <div class="flex items-center">\n' +
        '                <div class="bg-gray-200 p-2 rounded-full">\n' +
        '                    <span class="text-gray-800 font-bold">Logo</span>\n' +
        '                </div>\n' +
        '                <span class="ml-4 font-semibold text-lg tracking-wide text-gray-800">Admin Panel</span>\n' +
        '            </div>\n' +
        '            <nav class="py-4">\n' +
        ...
        '                                class="bg-red-500 hover:bg-red-600 text-white font-bold py-2 px-4 rounded" hidden>\n' +
        '                            Get Secret\n' +
        '                        </button>\n' +
        '                    </div>\n' +
        '                </div>\n' +
